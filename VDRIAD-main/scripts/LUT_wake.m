...
LUT.Name = "LUT03";
LUT.Label = ["Pressure";
             "Ion Wake Charge Ratio ";
             "Dust Charge";
             "Ion Wake Length Ratio"];

% Store pressure values
LUT.Pressure = TProc.Pressure;

% Store charge ratio
LUT.ChargeRatio(1) = fitCharge2.p1;
...
% Store length ratio
LUT.LengthRatio(1) = fitLength.p1;
LUT.LengthRatio(2) = fitLength.p2;
