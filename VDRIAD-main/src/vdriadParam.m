    ...
    methods
        ...
        function set.GAS_PRESSURE(obj,val)
            if val > obj.maxPressure
                obj.oldGAS_PRESSURE = obj.GAS_PRESSURE;
                disp('stop')
        ...
        function set.RADIAL_CONFINEMENT_COEFF(obj,val)
            if val > 0
                obj.RADIAL_CONFINEMENT_COEFF = val;
            else
                disp('Invalid value for RADIAL_CONFINEMENT_COEFF (must be > 0)')
            end
        end
	...
	methods (Access=private)
        ...
        function updateParameters(obj)
            ...
            if obj.e == 0
                ...
                obj.ION_DENSITY = obj.ION_DENSITY * (obj.GAS_PRESSURE / obj.oldGAS_PRESSURE);
                obj.e = obj.e + 1;
            end
