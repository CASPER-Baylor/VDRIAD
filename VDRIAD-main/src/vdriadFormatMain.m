...
%   various elements in the GUI.
    ...
    app.PressureSpinner.Limits = [0.01 20];

    % POWER SPINNER
    app.PowerSpinner.Value = app.Parameters.CELL_POWER;
    app.PowerSpinner.Step = 0.1;
    app.PowerSpinner.Limits = [1 100];

    % RADIAL_CONFINEMENT_COEFF SPINNER
    app.Radial_CofSpinner.Value = app.Parameters.RADIAL_CONFINEMENT_COEFF;
    app.Radial_CofSpinner.Step = 10;
    app.Radial_CofSpinner.Limits = [0 1000000];
